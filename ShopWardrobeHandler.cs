...
{
    public class ShopWardrobeHandler : MonoBehaviour
    {
        ...
        public static GameObject enabledisableShop;
        private static GameObject[] enabledisablearray = new GameObject[3];
        public static List<GameObject> newEnableDisableShop = new List<GameObject>();
        public static GameObject DynamicParent4;
        public static GameObject DynamicParent5;
        public static GameObject DynamicParent6;
        ...
        {
            Shop = GameObject.Find("Global/Levels/Forest/Props/Chill Cabin");
            Wardrobe = Shop.transform.Find("WardorbeShop").gameObject;
            ...
            Debug.Log(prevPage);
            nextPage.AddComponent<CustomPageSwitchShop>().mode = 0;
            prevPage.AddComponent<CustomPageSwitchShop>().mode = 1;
            enabledisableShop = WardrobeButtons.transform.GetChild(0).gameObject;
            enabledisablearray[0] = enabledisableShop.transform.GetChild(0).gameObject;
            enabledisablearray[1] = enabledisableShop.transform.GetChild(1).gameObject;
            enabledisablearray[2] = enabledisableShop.transform.GetChild(2).gameObject;
            Debug.Log(enabledisableShop);
            ...
            DynamicParent4 = HeadStands.transform.Find("Dynamic Parent 1").gameObject;
            DynamicParent5 = HeadStands.transform.Find("Dynamic Parent 2").gameObject;
            DynamicParent6 = HeadStands.transform.Find("Dynamic Parent 3").gameObject;
            ...
            ModdedButton.AddComponent<ShopButtonHandler>();
            ...
            displaySlots[0].localRotation = DynamicParent4.transform.localRotation;
            ...
            displaySlots[1].localRotation = DynamicParent5.transform.localRotation;
            ...
            displaySlots[2].localRotation = DynamicParent6.transform.localRotation;
        }
